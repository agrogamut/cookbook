...
WITH new_recipe AS (
  ...
  VALUES ('Chicken and Vegetable Wrap', 'MC-01', 'Breakfast', 'wrap', 'Non-vegetarian', 60, 119, '6–9 years', 'West Bengal / East India', 'Family texture', ARRAY['Make a soft flatbread from wheat flour.','Cook finely diced chicken with onion and tomato in mustard oil with turmeric.','Fill the flatbread with the chicken mixture and roll up.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Paneer and Vegetable Paratha', 'MC-01', 'Breakfast', 'flatbread', 'Vegetarian', 60, 119, '6–9 years', 'West Bengal / East India', 'Family texture', ARRAY['Mix crumbled paneer with grated carrot and coriander leaves.','Stuff into wheat flour dough and roll into a flatbread.','Cook on a griddle with a little ghee until golden.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Moong Dal and Vegetable Chilla', 'MC-01', 'Breakfast', 'pancake', 'Vegetarian', 60, 119, '6–9 years', 'West Bengal / East India', 'Family texture', ARRAY['Soak and blend moong dal to a thick batter.','Stir in finely chopped onion, tomato and coriander leaves.','Cook spoonfuls on a lightly oiled griddle until set on both sides.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Boiled Egg with Tomato Roti', 'MC-01', 'Breakfast', 'dish-mash', 'Eggetarian', 60, 119, '6–9 years', 'West Bengal / East India', 'Family texture', ARRAY['Make a soft flatbread from wheat flour with a little chopped tomato worked into the dough.','Cook on a griddle with a little ghee.','Serve alongside a boiled, halved egg.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Banana Semolina Upma with Cashew', 'MC-01', 'Breakfast', 'plate-upma', 'Vegetarian', 60, 119, '6–9 years', 'West Bengal / East India', 'Family texture', ARRAY['Dry-roast semolina and chopped cashew lightly in ghee.','Add water and cook, stirring, until it thickens.','Stir in mashed banana just before serving.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Chicken Keema Paratha', 'MC-01', 'Breakfast', 'flatbread', 'Non-vegetarian', 156, 216, '13–18 years', 'West Bengal / East India', 'Family texture', ARRAY['Cook minced chicken with onion, ginger, garlic and turmeric in mustard oil until dry.','Stuff into wheat flour dough and roll into a flatbread.','Cook on a griddle with a little oil until golden on both sides.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Paneer Bhurji with Paratha', 'MC-01', 'Breakfast', 'flatbread', 'Vegetarian', 156, 216, '13–18 years', 'West Bengal / East India', 'Family texture', ARRAY['Crumble paneer and cook with onion, tomato, turmeric and cumin in groundnut oil.','Make a soft wheat flour flatbread on a griddle.','Serve the paneer alongside the flatbread.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Chana Dal and Vegetable Chilla', 'MC-01', 'Breakfast', 'pancake', 'Vegetarian', 156, 216, '13–18 years', 'West Bengal / East India', 'Family texture', ARRAY['Soak and blend chana dal to a thick batter with a little water.','Stir in finely chopped onion, carrot and coriander leaves.','Cook spoonfuls on a lightly oiled griddle until set on both sides.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Cheese and Vegetable Paratha', 'MC-01', 'Breakfast', 'flatbread', 'Vegetarian', 156, 216, '13–18 years', 'North India', 'Family texture', ARRAY['Grate cheese and mix with finely chopped carrot and coriander leaves.','Stuff into wheat flour dough and roll into a flatbread.','Cook on a griddle with a little ghee until golden.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Chicken and Vegetable Poha', 'MC-01', 'Breakfast', 'bowl-grain', 'Non-vegetarian', 156, 216, '13–18 years', 'West Bengal / East India', 'Family texture', ARRAY['Cook finely diced chicken through in mustard oil with turmeric.','Add onion, carrot and green peas and cook until soft.','Rinse and add flattened rice, tossing gently until warmed through.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
...
WITH new_recipe AS (
  INSERT INTO ai_recipe (title, meal_category_id, meal_type, dish_format_id, diet_type, min_age_months, max_age_months, age_group, region_culture, texture, method_steps, model, prompt_version)
  VALUES ('Mixed Dal and Vegetable Khichdi Bowl', 'MC-01', 'Breakfast', 'pot-khichdi', 'Vegetarian', 156, 216, '13–18 years', 'West Bengal / East India', 'Family texture', ARRAY['Cook rice with moong dal and chana dal until soft.','Add carrot, green peas and turmeric and cook through.','Finish with ghee and cumin.'], 'hand-authored', 'corpus-fill-2026-09-06-batch3')
  RETURNING recipe_id
)
INSERT INTO ai_recipe_ingredient (recipe_id, ingredient_id, quantity_g)
